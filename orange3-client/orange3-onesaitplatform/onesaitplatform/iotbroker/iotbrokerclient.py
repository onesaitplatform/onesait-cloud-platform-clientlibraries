...
class IotBrokerClient(Client):
    ...
    def __init__(self, 
        ...
        .format(host, self.iot_broker_path, iot_client, iot_client_token))
        self.add_to_debug_trace("Created connection with iot-broker host:{}, path:{}, client:{}, token:{}"
        .format(host, self.iot_broker_path, iot_client, iot_client_token))
    ...
    def from_json(json_object):
        ...
        try:
            ...
            connection = IotBrokerClient(host=json_object['host'], iot_client=json_object['iot_client'], iot_client_token=json_object['iot_client_token'])
    ...
    def insert(self, ontology, list_data):
        """
        Make a insert query to iot-broker service of the platform
